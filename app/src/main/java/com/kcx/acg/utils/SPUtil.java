...
public class SPUtil {
    ...
    public static void put(Context context, String key, Object object) {
        ...
        if (object instanceof String) {
            String str = AESHelper.encrypt((String) object, SysApplication.uuid);
    ...
    public static Object get(Context context, String key, Object defaultObject) {
        ...
        if (defaultObject instanceof String) {
            ...
            return AESHelper.decrypt(str, SysApplication.uuid);
     ...
     * @return modified:
     */
    public static Object readObject(Context context, String key,Object defValue) {
        try {
...
//        SharedPreferences.Editor editor = sp.edit();
    ...
    public static void putString(Context context, String key, String object) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(key, object).commit();
    }
