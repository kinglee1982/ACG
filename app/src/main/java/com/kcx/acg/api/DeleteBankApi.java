 ...
 */
public class DeleteBankApi extends BaseApi {
    ...
    public DeleteBankApi(RxAppCompatActivity rxAppCompatActivity, HttpOnNextListener listener) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpService.deleteBank(memberBankID);
    }
}
