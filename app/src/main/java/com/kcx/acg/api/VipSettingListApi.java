 ...
 */
public class VipSettingListApi extends BaseApi {
    public VipSettingListApi(RxAppCompatActivity rxAppCompatActivity, HttpOnNextListener listener) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpService.GetVIPSettingList();
    }
}
