 ...
 */
public class SelectMemberBankApi extends BaseApi {
    public SelectMemberBankApi(RxAppCompatActivity rxAppCompatActivity, HttpOnNextListener listener) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpService.selectMemberBank();
