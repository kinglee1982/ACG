 ...
 */
public class ProductToMenberListApi extends BaseApi {
    ...
    public ProductToMenberListApi(RxAppCompatActivity rxAppCompatActivity, HttpOnNextListener listener) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpService.getProductToMenberList(getMenberId(),getPageIndex(),getPageSize());
    }
}
