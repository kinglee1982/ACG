 ...
 */
public class UserIncomeInfoApi extends BaseApi {

    public UserIncomeInfoApi(RxAppCompatActivity rxAppCompatActivity, HttpOnNextListener listener) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpService.getUserIncomeInfo();
    }
}
