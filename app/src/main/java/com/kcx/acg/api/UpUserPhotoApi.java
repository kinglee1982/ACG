 ...
 */
public class UpUserPhotoApi extends BaseApi {
    ...
    public UpUserPhotoApi(RxAppCompatActivity rxAppCompatActivity, HttpOnNextListener listener) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpService.upUserPhoto(getPart());
    }
}
