...
public class PicturePager2Adapter extends PagerAdapter {
    ...
    public PicturePager2Adapter(Context context, List<String> pathList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String imgUrl;
        if (isHdvMode) {
            imgUrl = pathList.get(position).replace("_S.", "_L.");
        } else {
            imgUrl = pathList.get(position).replace("_S.", "_M.");
        }
