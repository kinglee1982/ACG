...
public class NoteRadioGroup extends LinearLayout{
    ...
    public NoteRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == NoteRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == NoteRadioGroup.this && child instanceof ViewGroup) {
